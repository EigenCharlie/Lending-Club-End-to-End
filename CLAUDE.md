...
- **Paper-facing tables** (`reports/paper_material/paper1/tables/*`) are regenerated ONLY via `scripts/export_paper1_canonical_tables.py` from `models/final_project_promotion.json`, the bound-aware 276K shortlist, and the P1 evidence generator. Do NOT mix legacy frontier outputs with paper tables.
- **Paper Estrella P1 evidence** lives in `models/paper1_p1_evidence_status.json`, `docs/research/paper_estrella_p1_evidence_2026-05-04.md`, and `paper1_tableA3`--`paper1_tableA6`: post-selection 5K--25K--276K progression, segment-period sensitivity, CROMS-style decision-aware selector, and synthetic shift stress tests.
