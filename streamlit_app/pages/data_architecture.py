...
from streamlit_app.utils import get_notebook_image_path, page_error_boundary, query_duckdb, try_load_json, try_load_parquet
...
with page_error_boundary("data_architecture"):
    digraph G {{
        rankdir=LR;
        bgcolor="white";
    ...
    with st.status("Cargando snapshot de arquitectura (datasets, Feast, dbt)...", expanded=False) as _arch_status:
        ...
        feature_iv = try_load_json("feature_importance_iv")
