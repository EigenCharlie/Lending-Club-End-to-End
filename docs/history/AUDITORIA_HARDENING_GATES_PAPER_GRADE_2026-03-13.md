> **HISTORICAL** — Auditoría cerrada y archivada. Mantener solo como trazabilidad de marzo 2026; para el estado vivo priorizar `docs/CANONICAL_DOCUMENTATION_AND_QUARTO_TRACEABILITY_2026-03-30.md`.
...
- Ejemplo: `docs/history/PROMOTION_DOSSIER_2026-03-01.md`.
