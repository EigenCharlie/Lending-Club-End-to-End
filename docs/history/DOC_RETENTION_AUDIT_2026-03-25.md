...
| File | Decision | Reason |
|---|---|---|
| `docs/history/OFFICIAL_RERUN_MASTER_PLAN_2026-02-27.md` | keep-historical | Contains provenance of the official rerun and already carries a historical banner. |
| `docs/history/PROMOTION_DOSSIER_2026-03-01.md` | keep-historical | Historical promotion snapshot, still useful for audit trail. |
| `docs/history/DEPLOY_STREAMLIT_FREE.md` | keep-historical | Useful only if someone ever needs to rebuild the frozen public showcase. |
| `docs/history/ENGINEERING_ENVS_AND_UPGRADE_PLAN_2026-02-25.md` | keep-historical | Old environment migration notes that may still help if infra drifts. |
