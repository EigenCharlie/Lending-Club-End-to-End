# Paper 4 Post-Scripts-SIM108-Repair Pytest Probe v441
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1179`.
- Runtime seconds: `193.547`.
- Summary: `=========== 1179 passed, 2 skipped, 13 warnings in 179.10s (0:02:59) ===========`.
- Repository ruff diagnostics: `9`.
- Repository SIM108 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Book diagnostics: `0`.
- Top executable rule: `C405`.
...
Build `paper4_v442_scripts_c405_set_literal_repair_batch.md`.
