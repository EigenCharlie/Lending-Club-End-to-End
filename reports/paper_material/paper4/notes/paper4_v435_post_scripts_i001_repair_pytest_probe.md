# Paper 4 Post-Scripts-I001-Repair Pytest Probe v435
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1173`.
- Runtime seconds: `168.838`.
- Summary: `=========== 1173 passed, 2 skipped, 13 warnings in 156.56s (0:02:36) ===========`.
- Repository ruff diagnostics: `18`.
- Repository I001 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Top executable rule: `F401`.
...
Build `paper4_v436_scripts_book_f401_unused_import_repair_batch.md`.
