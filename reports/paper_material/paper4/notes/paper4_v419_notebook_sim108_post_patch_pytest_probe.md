# Paper 4 Post-SIM108 Pytest Probe v419
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1157`.
- Runtime seconds: `194.632`.
- Summary: `=========== 1157 passed, 2 skipped, 13 warnings in 181.76s (0:03:01) ===========`.
- Notebook diagnostics: `3`.
- Notebook SIM108 diagnostics: `0`.
...
Build `paper4_v420_notebook_gpu_style_lint_triage.md`.
