# Paper 4 Post-Scripts-UP022-Repair Pytest Probe v439
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1177`.
- Runtime seconds: `174.781`.
- Summary: `=========== 1177 passed, 2 skipped, 13 warnings in 160.91s (0:02:40) ===========`.
- Repository ruff diagnostics: `11`.
- Repository UP022 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Book diagnostics: `0`.
- Top executable rule: `SIM108`.
...
Build `paper4_v440_scripts_sim108_conditional_expr_repair_batch.md`.
