# Paper 4 Post-Sys.path-Refactor Pytest Probe v406
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1144`.
- Runtime seconds: `191.953`.
- Summary: `=========== 1144 passed, 2 skipped, 13 warnings in 183.43s (0:03:03) ===========`.
- Notebook diagnostics: `20`.
- Notebook E402 diagnostics: `0`.
...
Build `paper4_v407_notebook_non_e402_lint_triage.md`.
