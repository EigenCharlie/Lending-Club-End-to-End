# Paper 4 Post-B018 Fig.show Pytest Probe v411
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1149`.
- Runtime seconds: `151.713`.
- Summary: `=========== 1149 passed, 2 skipped, 13 warnings in 141.50s (0:02:21) ===========`.
- Notebook diagnostics: `7`.
- Notebook B018 diagnostics: `0`.
...
Build `paper4_v412_notebook_f821_execution_context_audit.md`.
