# Paper 4 Post-Scripts-F401-Repair Pytest Probe v437
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1175`.
- Runtime seconds: `176.412`.
- Summary: `=========== 1175 passed, 2 skipped, 13 warnings in 162.22s (0:02:42) ===========`.
- Repository ruff diagnostics: `14`.
- Repository F401 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Book diagnostics: `0`.
- Top executable rule: `UP022`.
...
Build `paper4_v438_scripts_up022_capture_output_repair_batch.md`.
