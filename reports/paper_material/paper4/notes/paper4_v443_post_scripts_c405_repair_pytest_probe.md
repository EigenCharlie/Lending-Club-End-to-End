# Paper 4 Post-Scripts-C405-Repair Pytest Probe v443
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1181`.
- Runtime seconds: `182.633`.
- Summary: `=========== 1181 passed, 2 skipped, 13 warnings in 167.36s (0:02:47) ===========`.
- Repository ruff diagnostics: `8`.
- Repository C405 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Book diagnostics: `0`.
- Top executable rule: `SIM223`.
...
Build `paper4_v444_scripts_sim223_expr_and_false_repair_batch.md`.
