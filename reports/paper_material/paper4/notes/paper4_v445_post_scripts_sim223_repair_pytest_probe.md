# Paper 4 Post-Scripts-SIM223-Repair Pytest Probe v445
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1183`.
- Runtime seconds: `216.738`.
- Summary: `=========== 1183 passed, 2 skipped, 13 warnings in 200.94s (0:03:20) ===========`.
- Repository ruff diagnostics: `7`.
- Repository SIM223 diagnostics: `0`.
- Streamlit diagnostics: `0`.
- Notebook diagnostics: `0`.
- Book diagnostics: `0`.
- Top executable rule: `B023`.
...
Build `paper4_v446_scripts_b023_loop_binding_manual_repair_batch.md`.
