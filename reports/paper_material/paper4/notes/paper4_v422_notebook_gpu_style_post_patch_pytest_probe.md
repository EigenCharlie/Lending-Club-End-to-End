# Paper 4 Post-GPU-Style Pytest Probe v422
...
- Exit code: `0`.
- Pytest passed: `True`.
- Collected items: `1160`.
- Runtime seconds: `147.236`.
- Summary: `=========== 1160 passed, 2 skipped, 13 warnings in 135.84s (0:02:15) ===========`.
...
Build `paper4_v423_repository_ruff_frontier_after_notebook_clean.md`.
