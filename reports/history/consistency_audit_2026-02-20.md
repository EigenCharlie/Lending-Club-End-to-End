> **HISTORICAL** — Audit snapshot from 2026-02-20. Issues found were resolved at the time. For current state, see `docs/DOCUMENTATION_MAP.md`.
...
- Fixes applied:
  - `reports/history/hpo_research_notes_2026-02-19.md` updated to `PMC9222552`
...
- Historical/static docs still mention old Platt/ECE values:
  ...
  - historical snapshots (e.g., `reports/history/project_audit_snapshot.json`)
