# Run Comparison: 2026-03-01-C-smart-v2

- Generated: 2026-03-01T18:38:01.370644+00:00
...
- `models/conformal_lgd_ead_status.json`: hash_changed=True, baseline_exists=False, current_exists=True
- `models/conformal_policy_status.json`: hash_changed=True, baseline_exists=False, current_exists=True
- `models/fairness_audit_status.json`: hash_changed=True, baseline_exists=False, current_exists=True
- `models/survival_summary.pkl`: hash_changed=True, baseline_exists=False, current_exists=True
- `reports/dvc/metrics_summary.json`: hash_changed=True, baseline_exists=False, current_exists=True
