...
La @fig-p1-spo-regret no muestra que CRPTO "pierde" contra SPO+; muestra el **trade-off diseñado**: SPO+ optimiza regret directamente (49.1% reducción), mientras CRPTO optimiza robustez bajo incertidumbre auditable. El regret más alto de CRPTO es el **precio de la auditabilidad** --- la policy es más conservadora porque protege contra realizaciones adversas con cobertura verificable (92.97%). Un regulador puede auditar la cobertura de CRPTO; no puede auditar si el regret de SPO+ se mantendrá bajo distributional shift.
:::
