...
La @fig`Paper_CRPTO` presenta la comparación con el formato y nivel de detalle utilizado en el CRPTO/Paper_CRPTO (@sec`Paper_CRPTO`). Esta figura resume las tres dimensiones del trade-off (cobertura global, ancho medio, cobertura mínima por grupo) en un solo panel, facilitando la lectura comparativa para revisores de journals.
