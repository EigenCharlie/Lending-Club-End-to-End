...
La @fig-estrella-alpha-pareto muestra la frontera Pareto con el formato utilizado en el Paper Estrella, donde el eje horizontal representa el nivel de confianza (1-α) y el eje vertical los KPIs de portafolio resultantes. Esta visualización permite a un revisor evaluar de un vistazo cuánto "cuesta" cada punto porcentual adicional de confianza en términos de retorno esperado.

![Frontera Pareto de alpha sweep: trade-off entre nivel de confianza conformal y KPIs de portafolio, formato de publicación.](../../assets/figures/publication/estrella_fig8_alpha_pareto.png){#fig-estrella-alpha-pareto fig-alt="Frontera Pareto mostrando cobertura vs retorno vs ancho para diferentes niveles alpha."}
