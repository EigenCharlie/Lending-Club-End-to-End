...
page-layout: article
close_takeaway: "El modelo champion (CatBoost calibrado, AUC 0.7124, ECE 0.0064) se selecciona por validación temporal estricta sobre datos OOT. La calibración no es opcional: un modelo con buen ranking pero probabilidades incorrectas produce provisiones IFRS9 erróneas y portafolios frágiles."
...
close_reuse: "Las métricas del champion (`model_comparison.json`, `pd_training_record.pkl`) son la referencia canónica para explicabilidad (@sec-global-explanations), fairness (@sec-mrm), backtesting conformal (@sec-backtest-monitoring), Paper 2, Paper 4 y el proyecto externo CRPTO."
---
