...
| Condición de decisión | Calibrador preferido | Validación final |
|---|---|---|
| Se requieren garantías formales de calibración | Venn-Abers | Brier, Z-statistic, log-loss y comparación contra modelo sin calibrar |
| No se requieren garantías y `m < 200` | Platt Scaling | Brier, Z-statistic, log-loss y comparación contra modelo sin calibrar |
| No se requieren garantías y `200 <= m < 1000` | Beta Calibration | Brier, Z-statistic, log-loss y comparación contra modelo sin calibrar |
| No se requieren garantías, `m >= 1000` y scores simétricos | Isotónica | Brier, Z-statistic, log-loss y comparación contra modelo sin calibrar |
| No se requieren garantías, `m >= 1000` y scores asimétricos | Beta Calibration | Brier, Z-statistic, log-loss y comparación contra modelo sin calibrar |

: Árbol de decisión para selección de calibrador {#tbl-calibration-decision}
