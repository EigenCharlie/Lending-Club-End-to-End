...
La regla editorial se mantiene: CRPTO/Paper_CRPTO usa PyEPO solo para reproducir
...
CRPTO/Paper_CRPTO [@tang2024cave].
...
Para **CRPTO/Paper_CRPTO**, usar solo el paired run:
`crpto_external_pyepo137_wls_topk_paired_20260528`. El numero actualizado es
...
- `reports/paper_material/crpto_external/pyepo/crpto_external_pyepo137_wls_topk_paired_20260528/`
